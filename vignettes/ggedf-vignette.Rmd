...
vector, or distribution X and the function itself finds the proportions of each 
value of X that is less or equal to the current value. It is most often used when 
creating a step-function plot, which is shown below. Each "step" shows the fraction
1/n at each data point of n observations.
...
```{r}
ggplot2::ggplot(data = ggplot2::mpg, ggplot2::aes(x = wt)) +
...
that returns a percentile summary graph with confidence intervals of the EDF 
